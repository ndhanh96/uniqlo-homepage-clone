  ...
  return (
    <>
      ...
      <div
        ...
        className='grid grid-cols-2 space-y-6 mx-6 lg:mx-16 xl:mx-8 2xl:xl:mx-80 my-4 border-slate-200 '
      >
      ...
      <div id='app-offer' className='mx-6 lg:mx-16 xl:mx-8 2xl:xl:mx-80 '>
